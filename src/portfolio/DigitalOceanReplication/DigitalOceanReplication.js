...
<React.Fragment>
    ...
    <section className="digital-ocean-hero">
      ...
      <form className="digital-ocean-signup">
        ...
        <button className="digital-ocean-signup__button signup__button--google">
          <img className="digital-ocean-signup__button-logo" src="./assets/google-favicon-512.png" alt="Google logo" />
    ...
    <section className="digital-ocean-other-customers">
      ...
      <ul className="digital-ocean-other-customers__logos">
        <li className="digital-ocean-other-customers__logo-container">
          <img className="digital-ocean-other-customers__logo" src="./assets/docker.png" alt="Docker" />
        </li>
        <li className="digital-ocean-other-customers__logo-container">
          <img className="digital-ocean-other-customers__logo" src="./assets/gitlab.png" alt="GitLab" />
        </li>
        <li className="digital-ocean-other-customers__logo-container">
          <img className="digital-ocean-other-customers__logo" src="./assets/slack.png" alt="slack" />
        </li>
        <li className="digital-ocean-other-customers__logo-container">
          <img className="digital-ocean-other-customers__logo" src="./assets/hashicorp.png" alt="HashiCorp" />
        </li>
        <li className="digital-ocean-other-customers__logo-container">
          <img className="digital-ocean-other-customers__logo" src="./assets/wework.png" alt="wework" />
        </li>
        <li className="digital-ocean-other-customers__logo-container">
          <img className="digital-ocean-other-customers__logo" src="./assets/splunk.png" alt="splunk" />
        </li>
      </ul>
    ...
    <section className="digital-ocean-sales-pitch-two">
      ...
      <ul className="digital-ocean-sales-pitch-two__pitches-container">
        <li className="digital-ocean-sales-pitch-two__pitch-container">
          <img className="digital-ocean-sales-pitch-two__pitch-logo" src="./assets/svg49.svg" alt="" />
        ...
        <li className="digital-ocean-sales-pitch-two__pitch-container">
          <img className="digital-ocean-sales-pitch-two__pitch-logo" src="./assets/svg11.svg" alt="" />
        ...
        <li className="digital-ocean-sales-pitch-two__pitch-container">
          <img className="digital-ocean-sales-pitch-two__pitch-logo" src="./assets/svg51.svg" alt="" />
        ...
        <li className="digital-ocean-sales-pitch-two__pitch-container">
          <img className="digital-ocean-sales-pitch-two__pitch-logo" src="./assets/svg18.svg" alt="" />
    ...
    <section className="digital-ocean-quotes">
      ...
      <div className="digital-ocean-quotes__quotes-container">
        ...
        <div className="digital-ocean-quotes__quote-main-container">
          <img className="digital-ocean-quotes__affiliation-logo" src="./assets/rockerbox-logo.png" alt="rockerbox" />
    ...
    <footer className="digital-ocean-footer">
      <div className="digital-ocean-footer__main">
        <img className="digital-ocean-footer__logo" src="./assets/svg0.svg" alt="Digital Ocean Logo" />
